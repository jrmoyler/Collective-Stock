...
const assets = [
  { id: "1", title: "Biological Age Trajectory", division: "Eon Core", divisionSlug: "eon-core", category: "UI Mockups", categorySlug: "ui-mockups", mediaType: "image", width: 1600, height: 900, semanticTags: ["longevity", "biomarkers"], searchKeywords: ["health dashboard"], intendedUse: ["application screen"], license: { slug: "collective-ai-internal-use" }, visibility: "internal", fileFormat: "png", featured: true },
  { id: "2", title: "Quantum Ledger Hero", division: "Quantum Ledger", divisionSlug: "quantum-ledger", category: "Hero Images", categorySlug: "hero-images", mediaType: "image", width: 900, height: 1600, semanticTags: ["finance", "ledger"], searchKeywords: ["quantum finance"], intendedUse: ["website hero"], license: { slug: "public-download" }, visibility: "public", fileFormat: "webp", featured: false }
];
