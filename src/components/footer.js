...
export function Footer() {
  ...
  return el("footer", { class: "site-footer" }, [
    el("div", { class: "footer-main" }, [
      ...
      el("div", { class: "footer-column" }, [el("h2", { text: "Discover" }), el("a", { href: collectionRoute("component-sheets"), text: "Component sheets" }), el("a", { href: collectionRoute("division-intro-videos"), text: "Intro films" }), el("a", { href: collectionRoute("complete-archive"), text: "Complete archive" })]),
