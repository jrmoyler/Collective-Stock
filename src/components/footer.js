...
export function Footer() {
  ...
  return el("footer", { class: "site-footer" }, [
    el("div", { class: "footer-main" }, [
      ...
      el("div", { class: "footer-column" }, [el("h2", { text: "Connect" }), el("a", { href: "/mcp", text: "MCP connector" }), el("a", { href: "/#licensing", text: "Licensing" }), el("a", { href: "/audit.html", text: "Asset audit" })]),
