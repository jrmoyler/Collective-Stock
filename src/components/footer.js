...
export function Footer() {
  ...
  return el("footer", { class: "site-footer" }, [
    el("div", { class: "footer-main" }, [
      ...
      el("div", { class: "footer-column" }, [el("h2", { text: "Discover" }), el("a", { href: collectionRoute("featured"), text: "Featured" }), el("a", { href: collectionRoute("recently-added"), text: "Recently added" }), el("a", { href: collectionRoute("complete-archive"), text: "Complete archive" })]),
